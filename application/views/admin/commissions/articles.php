        ...
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons tw-mb-2 sm:tw-mb-4">
                    ...
                    <a href="<?php echo admin_url('commissions/article'); ?>" class="btn btn-primary mright5">
                        <i class="fa-regular fa-plus tw-mr-1"></i>
                        <?php echo _l('new_commission'); ?>
                    </a>
                                  ...
                                  $articles = $this->db->get()->result_array(); ?>
                                      ...
                                      echo 'line-throught';
                                                                ...
                                                                <div class="panel-body">
                                                                    <a
                                                                        href="<?php echo admin_url('commissions/view/' . $article['slug']); ?>">
                                                                        <?php echo $article['subject']; ?>
                                                                    </a>
                                                                    <?php if ($has_permission_edit) { ?>
                                                                    <a href="<?php echo admin_url('commissions/article/' . $article['articleid']); ?>"
                            ...
                            <div role="tabpanel" class="tab-pane active" id="list_tab">
                                <div class="col-md-12 panel-table-full">
                                    <div class="panel_s">
                                      ...
                                      [
                                   _l('commission_dt_table_heading_detail'),
                                   _l('commission_dt_table_heading_amount'),
                                   _l('commission_dt_table_heading_action'),
                                 ],
                                      'articles',
                                      [],
                                      [
